# 2048  [![Netlify Status](https://api.netlify.com/api/v1/badges/8c4d891e-e180-41f1-b0b9-08f24c2b36a0/deploy-status)](https://app.netlify.com/sites/tc-2048/deploys)

This is a mock of the well known 2048 game. I had always wanted to see how I would attempt to create a game like this using my own logic. So I had the time
